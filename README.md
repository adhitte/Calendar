## Calendar Desktop Application
  A simple desktop calendar app built with **Python** and **PyQt5**.
  This is my very first desktop app project and was created as a beginner friendly exploration of GUI environment in Python
